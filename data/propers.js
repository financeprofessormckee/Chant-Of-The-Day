 ...
 *
 * COVERAGE: all of Ordinary Time (ot-2..ot-33 + Christ the King), the full
 * sanctoral already in the calendar, the Advent & Christmas seasons, Lent &
 * Holy Week through Holy Thursday (Ash Wednesday + the five Sundays of Lent +
 * Palm Sunday + Holy Thursday, with the Scrutiny-Mass year variants), and the
 * whole of Eastertide through Pentecost — Easter Sunday (the one paschal
 * Gradual, Haec dies), the 2nd–7th Sundays of Easter, the Ascension, the
 * Pentecost Vigil, and Pentecost Day — now carry their sung propers, with the
 * year-specific Communions keyed -a/-b/-c. Still Introit-only until sourced the
 * same way: only the summer solemnities (Corpus Christi, Trinity, Sacred Heart).
 * Each batch has its own build script + worklist under sources/gregobase/.
 * --------------------------------------------------------------------------
 */
