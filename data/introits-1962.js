...
window.INTROITS_1962 = {
  ...
  "pent-8": {
    ...
    blurb: {
      text: "This same text, \"Suscepimus Deus,\" is also the Introit for Candlemas / The Presentation of the Lord (this app's own candlemas entry). An anonymous polyphonic setting was printed in the 1528 Lyons Contrapunctus as part of a complete set of Candlemas Mass propers; the contemporary composer Robert Hugill wrote a five-voice (SATTB) setting, published in 2011.",
