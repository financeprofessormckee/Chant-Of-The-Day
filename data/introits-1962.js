...
window.INTROITS_1962 = {
  ...
  "holy-family": {
    ...
    blurb: {
      text: "Unusually for an Introit — nearly all of which draw their text straight from the Psalms — this one opens instead with a verse from the Book of Proverbs (23:24-25), only turning to a Psalm (83:2-3) for its continuation. It's the older of two Introits this app carries for the Holy Family: this 1962 Missal text was in place from the feast's 1893/1921 establishment, before the modern calendar replaced it after Vatican II with a different Introit, \"Deus in loco sancto suo\" (this app's own modern-calendar `holy-family` entry, itself recycled from the 17th Sunday in Ordinary Time).",
